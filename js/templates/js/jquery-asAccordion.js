      ...
      [
        {
          ...
          value: function init() {
            ...
            (0, _jquery2.default)(window).on(
			  ...
			  /*step_1*/
			  _visitedPopup[this.initialIndex] = 1;
            ...
            if (_jquery2.default.isArray(index)) {
              ...
              style[this.animateProperty] = distance;
				...
				if(this.current !== null && this.current !== "undefined" ) {
						enablePopupAudio(_pageData.sections[sectionCnt - 1].content.leftColumn.accordianInteractivity[this.current],  true, 1);
						_visitedPopup[this.current] = 1;
					if(this.size === _visitedPopup.length) {
						pageVisited();
					}
